...
class BasePredictor:
    ...
    def write_results(self, idx, results, batch):
        ...
        # # CUDA 장치에 있는 텐서를 호스트 메모리로 복사하여 CPU에 할당
        # tensor_cpu = im.cpu()
        ...
        # 텐서의 형태 변환
        image_array = im.permute(0, 2, 3, 1).squeeze().cpu().numpy()
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        with self._lock:  # for thread-safe inference
            ...
            for batch in self.dataset:
                ...
                # print("ssss", s)
                # print("self.batch.vid_stride", self.batch.vid_stride)
                ...
                for i in range(n):
                    ...
                    if self.seen % 10 == 0 and self.plotted_img is not None:
                        self.show(p)
                        # cv2.destroyAllWindows()
    ...
    def save_preds(self, vid_cap, idx, save_path):
        ...
        if self.dataset.mode == 'image':
            ...
            # print("vid_path[idx]", self.vid_path[idx], idx)
